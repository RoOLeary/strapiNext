      ...
      <Layout>
        ...
        <div className="-mt-24 pt-24 w-full h-screen bg-white flex flex-wrap">
            ...
            <div className="shadow-none pl-12 py-12 md:pl-0 sm:absolute md:relative z-10 intro ml-4">
              <h1 className="hidden md:block mb-8 text-3xl md:text-5xl text-gray-800 text-bold uppercase font-bold tracking-widest leading-tight">
                Isabel Vaz
              </h1>
        ...
        <div class="relative sm:-mt-12 -mt-24 px-12 py-24 flex items-center" style={{ "background": "#a7bcbb" }}>
